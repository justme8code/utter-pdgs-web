...
export const EditableConversion = ({
    ...
    return (
        <div className="flex items-center justify-center text-center gap-2">
            ...
            {renderField(`Output ${formData.ingredient?.uom}`, formData.outPutLitres, 'outPutLitres')}
            {renderField('PLitersLost', formData.productionLitresLost, 'productionLitresLost')}
            {renderField(`Usable ${formData.ingredient?.uom}`, formData.usableLitres, undefined, true)}
            {renderField('Litres/Kg(auto)', formData.litresPerKg, undefined, true)}
            {renderField(`₦ Cost ${formData.ingredient?.uom}`, formData.costPerLitre, undefined, true)}

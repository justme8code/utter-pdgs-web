...
export const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles = `px-4 py-2 rounded-md font-medium transition duration-200 inline-flex items-center justify-center ${className}`;
    const variantStyles = {
        primary: `bg-blue-500 text-white hover:bg-blue-600 ${className}`,
        secondary: `bg-gray-500 text-white hover:bg-gray-600 ${className}`,

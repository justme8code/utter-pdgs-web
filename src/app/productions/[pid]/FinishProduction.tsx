...
import {finishProduction} from "@/app/actions/production"; // Icons
...
export const FinishProduction = () => {
    ...
    return (
        <>
            ...
            {/* Result Dialog */}
            <AppDialog isOpen={isResultOpen} onClose={() => setIsResultOpen(false)} title={isSuccess ? "Production Finalized" : "Finalization Failed"}>
                <div className="p-1 space-y-4 text-center">
                    ...
                    { !isSuccess && <p className="text-sm text-muted-foreground">Please check for any pending tasks or try again.</p>}

...
import EditableTable, {DataType, RowType} from "@/app/productions/EditableTable";
...
export const RawMaterialsToIngredientsTest = ({ production, columns }: { production: ExtendedProductionResponse, columns: ColumnType[] }) => {
